...
// configuration step. It creates a namespace called `cppCmakeTemplateWork`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cppCmakeTemplateWork::cmake::project_name, cppCmakeTemplateWork::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cppCmakeTemplateWork::cmake::project_version);
      return EXIT_SUCCESS;
    }
